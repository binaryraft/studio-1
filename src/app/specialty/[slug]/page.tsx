...
import { ArrowRight, ArrowLeft, CheckCircle2, MessageSquare, Zap, Cloud, Code2, ShieldCheck, LifeBuoy, GitBranch, Cpu, Brain } from 'lucide-react';
                            ...
                            <div className="grid lg:grid-cols-12 gap-20 items-center">
                                ...
                                <div className="lg:col-span-7 space-y-10">
                                    ...
                                    <div className="flex flex-wrap gap-5 pt-10 animate-fade-in-up [animation-delay:300ms]">
                                        ...
                                        >
                                            {/* Navigation to complete services ecosystem */}
